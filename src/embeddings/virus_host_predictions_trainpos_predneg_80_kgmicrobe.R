...
embeddings <- read.csv("/global/scratch/marcin/N2V/embiggen/notebooks/kg_microbe/link_predict_kgmicrobe_shape_80/SkipGram_embedding_kgmicrobe_80.csv", sep="\t", header=TRUE, row.names=1)
head(embeddings)
dim(embeddings)
